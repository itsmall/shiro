...
import cn.itcast.shiro.config.CORSAuthenticationFilter;
import cn.itcast.shiro.config.MyExceptionHandler;
...
//自定义过滤器
        ...
        filterMap1.put("corsAuthenticationFilter", corsAuthenticationFilter());
        filterFactory.setFilters(filterMap1);
*/
